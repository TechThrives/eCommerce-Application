                  ...
                  <section className="flex-1">
                    ...
                    <div className="flex flex-col justify-between items-center">
                      <button
                        ...
                        className="w-full flex items-center justify-center py-3.5 px-7 text-sm font-semibold tracking-wider rounded-md text-white bg-stone-900 hover:bg-stone-950 focus:outline-none"
                        disabled={isCheckoutLoading} // Disable button while loading
                      >
                        {isCheckoutLoading ? (
                          <>
                            <svg
