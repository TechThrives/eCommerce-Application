        ...
        public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
                ...
                return http
                                ...
                                .authorizeHttpRequests(auth -> auth
                                                ...
                                                .requestMatchers(HttpMethod.GET, "/api/products/category/slug/*")
                                                .permitAll()
                                                .requestMatchers(HttpMethod.GET, "/api/products/tags/suggestions")
                                                .permitAll()
                                                ...
                                                .requestMatchers(HttpMethod.GET, "/api/reviews/product/slug/*")
                                                .permitAll()
                                                .requestMatchers(HttpMethod.GET, "/api/reviews/product-summary/slug/*")
                                                .permitAll()
